...
const tables = [
  ...
  "CREATE TABLE Meeting (meeting_no int, meeting_title varchar(30), starting_time timestamp, ending_time timestamp, room_no varchar(5))",
];
...
const insert_queries = [
  ...
  "INSERT INTO Meeting VALUES (1, 'Building for the Future', '2020-11-03 12:00', '2020-12-03 12:00', 'a2')",
  "INSERT INTO Meeting VALUES (2, 'Customer Focus', '2020-11-03 12:00', '2020-11-04 12:00', 'b12')",
  "INSERT INTO Meeting VALUES (3, 'Do Great Things', '2020-01-23 08:00', '2020-01-24 12:00', 'c3')",
  "INSERT INTO Meeting VALUES (4, 'Igniting Team Spirit', '2020-08-13 12:00', '2020-11-13 12:00', 'd1')",
  "INSERT INTO Meeting VALUES (5, 'Anything is Possible', '2020-03-14 12:00', '2020-04-13 12:00', 'a7')",
];
